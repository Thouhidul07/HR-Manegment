...
const SUPPORTED_ROLES = [
  {
    code: "admin",
    name: "Admin / CEO",
    description: "System administration, user oversight, audit review, and read-only project overview",
    level: 1,
  },
  {
    code: "hr_manager",
...
const createRole = asyncHandler(async (req, res) => {
  ...
  const moduleMap = {
    ...
    "Project Management": ["projects", "project_tasks", "project_reports", "project_history", "wbs"],
  ...
  await logAudit({
    ...
    description: "Created custom role " + name.trim(),
    metadata: { modules },
    ipAddress: req.ip,
  });
