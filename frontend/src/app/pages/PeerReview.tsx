...
const mockReviews: PeerReview[] = [
  {
    ...
    duration: "6 months",
    rating: 5,
    review: "Sarah consistently demonstrates exceptional technical skills and leadership. She mentored junior developers effectively and delivered high-quality code on time. Her attention to detail and proactive communication made the project smoother for everyone.",
  ...
  },
  {
    ...
    duration: "4 months",
    rating: 4,
    review: "Michael did a great job keeping the team aligned and prioritizing features effectively. He was responsive to feedback and maintained clear documentation throughout. Sometimes decisions took longer than needed, but the outcomes were always well thought out.",
  ...
  },
  {
    id: "3",
    employeeAvatar: "JL",
    employeeName: "Jessica Liu",
    employeeRole: "Data Engineer",
    employeeDepartment: "Engineering",
    project: "Data Pipeline Migration",
    duration: "3 months",
    rating: 5,
    review: "Jessica's work on the migration was outstanding. She identified potential issues early, created comprehensive documentation, and ensured zero downtime during the transition. Her collaboration with the DevOps team was exemplary.",
  ...
  },
  {
    ...
    duration: "2 months",
    rating: 3,
    review: "David provided useful insights from the data, though sometimes the analysis could have been more in-depth. He was collaborative and open to feedback. With more experience, his analytical skills will continue to improve.",
  ...
  },
  {
    ...
    duration: "5 months",
    rating: 5,
    review: "Emily's thoroughness in the security audit was impressive. She identified critical vulnerabilities and provided actionable remediation plans. Her ability to explain complex security concepts to non-technical stakeholders was invaluable.",
