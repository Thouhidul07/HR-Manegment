...
const projectLeads: UserRole[] = ["admin", "hr_manager", "project_manager"];
    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "employees", element: <RoleRoute allowed={projectLeads}><EmployeeManagement /></RoleRoute> },
          { path: "employees/:id", element: <RoleRoute allowed={projectLeads}><EmployeeProfile /></RoleRoute> },
          ...
          { path: "project-management", element: <RoleRoute allowed={projectLeads}><ProjectManagement /></RoleRoute> },
          { path: "new-task", element: <RoleRoute allowed={projectLeads}><NewTask /></RoleRoute> },
          { path: "project-reports", element: <RoleRoute allowed={projectLeads}><ProjectReports /></RoleRoute> },
          { path: "project-history", element: <RoleRoute allowed={projectLeads}><ProjectHistory /></RoleRoute> },
          { path: "design-wbs", element: <RoleRoute allowed={projectLeads}><DesignWBS /></RoleRoute> },
