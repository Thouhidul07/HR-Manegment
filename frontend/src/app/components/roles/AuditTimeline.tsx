...
const auditLogs = [
  ...
  },
  {
    ...
    description: "Assigned 'Finance Officer' role to Emily Davis",
    user: { name: "Sarah Johnson", avatar: "SJ" },
  ...
  },
  {
    ...
    description: "Temporary admin access granted to James Wilson for system migration",
  ...
  },
  {
    ...
    description: "Revoked 'Super Admin' access from Robert Wilson",
    user: { name: "Sarah Johnson", avatar: "SJ" },
