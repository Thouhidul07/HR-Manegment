...
const navConfig = {
  admin: [
    ...
    { path: '/dashboard/employees',    label: 'Users & Teams',             icon: Users },
    ...
    { path: '/dashboard/performance',  label: 'Performance Overview',      icon: Target },
    { path: '/dashboard/roles',        label: 'Roles, Permissions & Audit', icon: Shield },
    ...
    { path: '/dashboard/expense',      label: 'Expense Management',        icon: Receipt },
    { path: '/dashboard/training',     label: 'Training & Development',    icon: GraduationCap },
    { path: '/dashboard/peer-review',  label: 'Peer Review Analytics',     icon: Star },
    { path: '/dashboard/cv-filter',    label: 'CV Filtration',             icon: TrendingUp },
    { path: '/dashboard/job-circulars', label: 'Job Circulars',            icon: Briefcase },
  ],
  hr_manager: [
    { path: '/dashboard',              label: 'Dashboard',                 icon: LayoutDashboard },
    ...
    { path: '/dashboard/attendance',   label: 'Attendance & Time',         icon: Clock },
    { path: '/dashboard/leave',        label: 'Leave Management',          icon: FileText },
    { path: '/dashboard/tasks',        label: 'HR Task Management',        icon: ListChecks },
    { path: '/dashboard/payroll',      label: 'Payroll Management',        icon: DollarSign },
  ...
  project_manager: [
    { path: '/dashboard',                    label: 'Dashboard',              icon: LayoutDashboard },
    { path: '/dashboard/project-management', label: 'Project Management',     icon: Kanban },
    { path: '/dashboard/project-management?view=tasks', label: 'Project Tasks', icon: ListChecks },
    { path: '/dashboard/project-reports',    label: 'Project Reports',        icon: BarChart3 },
    { path: '/dashboard/project-history',    label: 'Project History',        icon: FolderGit2 },
    { path: '/dashboard/design-wbs',         label: 'Design WBS',             icon: Network },
    { path: '/dashboard/employees',          label: 'Team Members',           icon: Users },
    { path: '/dashboard/attendance',         label: 'Attendance & Time',      icon: Clock },
    { path: '/dashboard/performance',        label: 'Performance Reports',    icon: Target },
    { path: '/dashboard/forum',              label: 'Forum',                  icon: MessageSquare },
  ],
};
