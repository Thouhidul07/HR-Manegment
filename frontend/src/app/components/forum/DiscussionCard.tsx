...
import { ThumbsUp, MessageCircle, Eye, Heart, Lightbulb, Flag, AlertTriangle, Pencil, Trash2 } from "lucide-react";
...
export function DiscussionCard({ discussion, onEdit, onDelete }: DiscussionCardProps) {
  const { user } = useAuth();
